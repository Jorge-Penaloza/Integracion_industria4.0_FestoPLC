    ...
    while lastKey != 27:
        ...
        if len(arucofound[0])!=0:
            ...
            for i_c in range(conta):
                ...
                if id[0] == id_vista_pinza or id[0] == id_Vista_pallet:
                    id_detect_s9.append(id[0])
                    x_detect_s9.append((v11 + v21 + v31 + v41)/4)
                    y_detect_s9.append((v12 + v22 + v32 + v42)/4)       
                #vistas
                ...
                if id[0] == id_vista_correa2 and ( np.array_equal( np.array(cont_d),np.array([2,4,2,0,1,0,1,2,2])) or np.array_equal( np.array(cont_d),np.array([2,4,1,0,1,1,1,2,]))):                
                    ...
                    marker_node_5.setPosition(pos)
                    mesh_node_5.setVisible(True)  
                if id[0] == id_vista_pinza and cont9 == 0 and ( np.array_equal( np.array(cont_d),np.array([2,4,2,0,1,1,1,2,2])) or np.array_equal( np.array(cont_d),np.array([2,4,1,0,1,1,2,2,]))):                
                    print("np.array([0,0,0,0,0,0,1])")
                    mesh_node.setVisible(False)
                    mesh_node_2.setVisible(False)
                    mesh_node_3.setVisible(False)
                    ...
                    marker_node_5.setPosition(pos)
                    mesh_node_5.setVisible(True)  
                if id[0] == id_Vista_pallet and   cont9 == 1:                
                    print("np.array([0,0,0,0,0,0,1])")
                    mesh_node.setVisible(False)
                    mesh_node_2.setVisible(False)
                    mesh_node_3.setVisible(False)
            ...
            if len(id_detect_s8) == 2:
                ...
                if distancia <= 159:
                    ...
                    sw_d[8] = False
            if len(id_detect_s9) == 2:
                file = open("./distancias.txt", "a")
                distancia =  ((x_detect_s9[0]- x_detect_s9[1])**2 + (y_detect_s9[0]- y_detect_s9[1])**2)**0.5
                print("distancia9:",distancia)
                file.write("distancia9:"+str(distancia)+ os.linesep)
                file.close()
                print("cont9", cont9)
                if distancia <= 46:
                    sw9
